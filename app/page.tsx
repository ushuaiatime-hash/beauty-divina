...
const BIZ = { 
  ...
  phone: "541164475239", 
  addr: "Monte Grande, Buenos Aires", 
  pin: "1234" 
};
        ...
        <div style={{ display: "flex", alignItems: "center", maxWidth: 380 }}>
          {BSTEPS.map((s, i) => (
            <div key={s} style={{ display: "flex", alignItems: "center", flex: i < BSTEPS.length - 1 ? 1 : "0 0 auto" }}>
              ...
              <span style={{ marginLeft: 5, fontSize: 10, fontWeight: 600, color: step === s || ci > i ? "var(--acc)" : "var(--mu)", opacity: ci > i && step !== s ? 0.6 : 1 }}>{BLABELS[i]}</span>
